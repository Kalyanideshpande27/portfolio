...
const EducationAchievements = ({ theme }) => {
  ...
  return (
    <section
      id="education"
      className={`relative py-16 sm:py-20 md:py-25 px-4 sm:px-6 ${isDark ? "bg-gradient-to-b from-black via-gray-950 to-black" : "bg-gradient-to-b from-gray-100 via-gray-200 to-gray-100"}`}
    >
...
>
  ...
  <div className="relative max-w-4xl mx-auto">
    ...
    {/* Center Line */}
    <div className={`absolute left-1/2 top-0 h-full w-[1.5px] -translate-x-1/2 ${
        ...
        return (
          ...
          >
            ...
            <div className={`w-[46%] ${isLeft ? "block" : "hidden md:block"}`}>
              {isLeft && (
                <div className={`p-5 rounded-lg border transition duration-200 hover:shadow-sm ${
